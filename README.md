...
The automated functions for RFSI modelling, prediction, tuning, and cross-validation are now implemented in the R package [meteo](https://github.com/AleksandarSekulic/Rmeteo).
